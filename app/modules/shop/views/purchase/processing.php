<div class="tabbable">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href=""><?= Yii::t('ShopModule.money', 'Processing'); ?></a></li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="tabProcessingPurchases">
<?php
...
<?php
				...
				//$this->widget('bootstrap.widgets.TbJsonGridView', array(
					'dataProvider' => $processingPurchasesDataProvider,
					// ? 'filter' => $model,
					...
					'columns' => array(
						array(
							'id' => 'checkboxProcessingPurchaseId',
							'class' => 'CCheckBoxColumn',
							'selectableRows' => 20, // TODO from param: rows per page
						),						
						'id',
						array(
							'name' => 'processingPurchasesAmountWithCurrency',
							'type' => 'raw',
...
?>
<?php
				echo CHtml::submitButton(Yii::t('purchases', 'Purchase is delivered'), array(
